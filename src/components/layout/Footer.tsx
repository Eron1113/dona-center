        ...
        <div className="grid md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3 mt-6">
              <a href="https://wa.me/38348881400" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#25D366]/20 flex items-center justify-center hover:bg-[#25D366]/30 transition-all" aria-label="WhatsApp">
                <WhatsAppIcon />
              </a>
              <a href="https://instagram.com/donacenter" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-all" aria-label="Instagram">
                <InstagramIcon />
              </a>
              <a href="https://facebook.com/donacenter" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-all" aria-label="Facebook">
                <FacebookIcon />
              </a>
            </div>
          </div>
